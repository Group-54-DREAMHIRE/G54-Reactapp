    ...
    <>
      <Row style={{ padding: "5%" }} justify='space-between' className="jobpost-w" gutter={10}>
        <Col span={8}>
          <Row gutter={[0, 5]}>
            <Col span={24}>
              <Image height={200} src={'https://zos.alipayobjects.com/rmsportal/jkjgkEfvpUPVyRjUImniVslZfWPnJuuZ.png'} preview={false} />
            </Col>
            <Col span={24}>
              <Row>
        ...
        <Col span={16}>
          <Row>
           ...
           <Title level={2} style={{ marginTop: "0" }}>
            ...
            <Text className="job-text-w" strong>Posted Date </Text> 
          ...
          <Row style={{marginTop: '30px'}}>
            <Button 
              ...
              ><Link to={`/pendingresumes`}>Candidate Requests</Link> 
            </Button>
          </Row>
          {/* <ApplyJob/> */}
        </Col>
